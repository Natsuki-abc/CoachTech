...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'full_width_string' => ':attributeは全角を指定してください。',
    'katakana' => ':attributeはカタカナを指定してください。',
    'zenhankana' => ':attributeはカタカナを指定してください。',
    'password_pattern' =>
    ':attributeは数字、アルファベット大文字、アルファベット小文字、記号のうち2種類以上を含めてください。',
    'match_securimage_text' => '認証コードが間違っています。',
    'alpha_num_half' => ':attributeは半角英数字を指定してください。',
    'exist_date' => '存在する日付を指定してください。',
    'phone' => ':attributeに有効な電話番号を入力してください。',
];
